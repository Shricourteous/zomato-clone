      ...
      <div className='flex flex-row md:items-center justify-between gap-3'>
        ...
        <div className='flex items-center gap-6 text-xs md:text-base'>
          <div className=' flex items-center gap-2'>
            <span className='flex rounded items-center gap-1 text-white font-medium px-2 py-1 bg-green-600'>
              {props.restaurantRating} <TiStarFullOutline/>
            </span>
            <span>
              <strong>100</strong>
              <p className='border-dashed border-b border-gray-500'>Dining Review  </p>
            </span>
          </div>
          <div className=' flex items-center gap-2'>
            <span className='flex rounded items-center gap-1 text-white font-medium px-2 py-1 bg-green-600'>
            ...
            <span>
              <strong>100</strong>
              <p className='border-dashed border-b border-gray-500'>Delivery Review  </p>
            </span>
          </div>
        </div>
        </div>
